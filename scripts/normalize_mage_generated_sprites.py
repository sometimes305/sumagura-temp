...
SRC = ROOT / "assets" / "characters" / "mage" / "mage_source"
OUT = ROOT / "assets" / "characters" / "mage"
FRAME = 128
WIDE_FRAME = 128
...
def label_preview(sheets):
    ...
    out = OUT / "mage_chibi_preview.png"
    preview.save(out)
    return out
...
def main():
    body_src = SRC / "mage_body_only_master_v1.png"
    ...
    run_frames = body[4:8]
    jump_frames = [body[8], body[8]]
    fall_frames = [body[10], body[10]]
    neutral_body = body[12]
    side_body = body[13]
    up_body = body[14]
    down_body = body[15]

    neutral_attack_frames = [idle_frames[0], neutral_body, neutral_body, idle_frames[1]]
    side_attack_frames = [idle_frames[0], side_body, side_body, idle_frames[1]]
    up_attack_frames = [idle_frames[0], up_body, up_body, idle_frames[1]]
    down_attack_frames = [idle_frames[0], down_body, down_body, idle_frames[1]]
    air_neutral_frames = [jump_frames[0], neutral_body, fall_frames[0], fall_frames[1]]
    air_side_frames = [jump_frames[0], side_body, fall_frames[0], fall_frames[1]]
    air_down_frames = [fall_frames[0], down_body, down_body, fall_frames[1]]
    ...
    add("mage_idle_sheet.png", idle_frames)
    add("mage_run_sheet.png", run_frames)
    add("mage_attack_neutral_sheet.png", neutral_attack_frames)
    add("mage_attack_side_sheet.png", side_attack_frames)
    add("mage_attack_up_sheet.png", up_attack_frames)
    add("mage_attack_down_sheet.png", down_attack_frames)
    add("mage_jump_sheet.png", jump_frames)
    add("mage_fall_sheet.png", fall_frames)
    add("mage_hurt_sheet.png", [fall_frames[0], fall_frames[1], fall_frames[0]])
    add("mage_charge_sheet.png", [idle_frames[0], idle_frames[1], idle_frames[2]])
    add("mage_air_neutral_sheet.png", air_neutral_frames)
    add("mage_air_side_sheet.png", air_side_frames)
    add("mage_air_down_sheet.png", air_down_frames)
    add("mage_grab_sheet.png", [neutral_body, side_body, neutral_body])
    add("mage_dodge_sheet.png", [down_body, fall_frames[1]])
    add("mage_throw_sheet.png", [side_body, neutral_body, side_body, idle_frames[0]])
    add("mage_ledge_sheet.png", [idle_frames[0], idle_frames[1]])

    preview = label_preview(sheets)
    print("Generated mage sheets:")
